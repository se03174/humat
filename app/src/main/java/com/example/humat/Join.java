...
public class Join extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailText = findViewById(R.id.Email_ETXT);
        mPasswordText = findViewById(R.id.RPass_ETXT);
        mPasswordcheckText = findViewById(R.id.Passck_ETXT);
        mregisterBtn = findViewById(R.id.Register_BTN);
        mName = findViewById(R.id.Name_ETXT);
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(email, pwd).addOnCompleteListener(Join.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                // --------------------------------
                                 // 닉네임 가져오기
//                                        G.nickName = mName.getText().toString();
//
